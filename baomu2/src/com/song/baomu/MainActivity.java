...
import com.song.moredian.MoreDianActivity;
import com.song.moredian.MoreMainActivity;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	private ResideMenuItem itemCalendar5;
...
//		stopService(null);
	...
	private void setUpMenu() {
		...
		itemCalendar = new ResideMenuItem(this, R.drawable.icon_calendar,
				"设置定点");
		itemCalendar5 = new ResideMenuItem(this, R.drawable.icon_calendar,
				"路线选择");
		...
		itemCalendar5.setOnClickListener(this);
		...
		resideMenu.addMenuItem(itemCalendar5, ResideMenu.DIRECTION_LEFT);
	...
	public void onClick(View view) {
		if (view == itemHome) {
			...
			startActivity(intent);	
		}else if(view == itemCalendar5){
			
			Intent intent = new Intent(MainActivity.this, MoreMainActivity.class);
			startActivity(intent);	
